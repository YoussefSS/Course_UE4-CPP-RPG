...
ACollider::ACollider()
{
	...
	OurMovementComponent->UpdatedComponent = RootComponent; // The component that will move through the MovementComponent
...
void ACollider::Tick(float DeltaTime)
{
	...
	// Start rotation of the camera using Mouse
